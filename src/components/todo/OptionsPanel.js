...
function ColorButton(props: ColorButtonProps) {
  ...
  return (
    <div
      className="todo-options-panel-color-palette-btn"
      role="button"
      tabIndex={0}
...
function OptionsPanelButtonTooltip(props: { text: string }) {
  ...
  return <div className="todo-options-panel-btn-tooltip">{text}</div>;
}
...
function OptionsPanelButton(props: OptionsPanelButtonProps) {
  ...
  return (
    <div
      className="todo-options-panel-btn"
      role="button"
      tabIndex={0}
      aria-label={icon}
      onClick={click}
